        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <a class="btn btn-primary rounded-pill py-3 px-5 me-3" href="{{ route('search-professionals') }}">Find Doctor</a>
                    <a class="btn btn-outline-primary rounded-pill py-3 px-5" href="{{ route('search-professionals') }}">Read More</a>
                </div>
                <div class="col-lg-6">
