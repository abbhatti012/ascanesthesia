    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="{{asset('front/img/blog-2.jpg')}}" alt="">
                    ...
                    <div class="d-flex justify-content-between bg-light rounded p-4 mt-4 mb-4">
                        <div class="d-flex align-items-center">
                            <img class="rounded-circle me-2" src="{{asset('front/img/user.jpg')}}" width="40" height="40" alt="">
                            <span>John Doe</span>
                        </div>
                        <div class="d-flex align-items-center">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-4">
                        <img src="{{asset('front/img/user.jpg')}}" class="img-fluid rounded-circle" style="width: 45px; height: 45px;">
                        <div class="ps-3">
