    ...
    <h2 class="content-heading">Edit Doctor</h2>
       <div class="block">
           ...
           <div class="block-content">
             <form id="validation-form" action="{{ route('update-ins',$user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                 <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="cname" name="cname" value="{{ $user->cname }}" required>
                    </div>
                    <div class="col-md-6">
